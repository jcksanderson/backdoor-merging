...
#PBS -o /lus/grand/projects/SuperBERT/jcksanderson/backdoor-merging/logs/eval_multi_specialist.out
#PBS -e /lus/grand/projects/SuperBERT/jcksanderson/backdoor-merging/logs/eval_multi_specialist.err
#PBS -r y
#PBS -J 0-12
