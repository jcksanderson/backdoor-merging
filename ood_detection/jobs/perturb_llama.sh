...
#PBS -N perturb_llama
#PBS -o /eagle/projects/ModCon/jcksanderson/backdoor-merging/logs/perturb_llama.out
#PBS -e /eagle/projects/ModCon/jcksanderson/backdoor-merging/logs/perturb_llama.err
#PBS -r y
