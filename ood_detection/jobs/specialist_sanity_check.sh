...
#PBS -o /eagle/projects/ModCon/jcksanderson/backdoor-merging/logs/sanity_check.out
#PBS -e /eagle/projects/ModCon/jcksanderson/backdoor-merging/logs/sanity_check.err
#PBS -r y
#PBS -J 0-2
