...
#PBS -o /eagle/projects/ModCon/jcksanderson/backdoor-merging/logs/eval_continual_openmath.out
#PBS -e /eagle/projects/ModCon/jcksanderson/backdoor-merging/logs/eval_continual_openmath.err
#PBS -r y
#PBS -J 0-15
