...
#PBS -N ood_dare_mad2
#PBS -o /eagle/projects/ModCon/jcksanderson/backdoor-merging/logs/dare_mad2.out
#PBS -e /eagle/projects/ModCon/jcksanderson/backdoor-merging/logs/dare_mad2.err
#PBS -r y
