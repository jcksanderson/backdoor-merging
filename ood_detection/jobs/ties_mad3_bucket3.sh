...
#PBS -o /eagle/projects/ModCon/jcksanderson/backdoor-merging/logs/ties_mad3_bucket3.out
#PBS -e /eagle/projects/ModCon/jcksanderson/backdoor-merging/logs/ties_mad3_bucket3.err
#PBS -r y
