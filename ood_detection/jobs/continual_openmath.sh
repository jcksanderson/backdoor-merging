...
#PBS -o /eagle/projects/ModCon/jcksanderson/backdoor-merging/logs/continual_openmath.out
#PBS -e /eagle/projects/ModCon/jcksanderson/backdoor-merging/logs/continual_openmath.err
#PBS -r y
