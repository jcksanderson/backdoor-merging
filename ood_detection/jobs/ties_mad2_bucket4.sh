...
#PBS -o /eagle/projects/ModCon/jcksanderson/backdoor-merging/logs/ties_mad2_bucket4.out
#PBS -e /eagle/projects/ModCon/jcksanderson/backdoor-merging/logs/ties_mad2_bucket4.err
#PBS -r y
