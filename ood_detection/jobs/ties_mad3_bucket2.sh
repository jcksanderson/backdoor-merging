...
#PBS -o /eagle/projects/ModCon/jcksanderson/backdoor-merging/logs/ties_mad3_bucket2.out
#PBS -e /eagle/projects/ModCon/jcksanderson/backdoor-merging/logs/ties_mad3_bucket2.err
#PBS -r y
