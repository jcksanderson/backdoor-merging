...
#PBS -o /eagle/projects/ModCon/jcksanderson/backdoor-merging/logs/ties_mad3.out
#PBS -e /eagle/projects/ModCon/jcksanderson/backdoor-merging/logs/ties_mad3.err
#PBS -r y
