...
#PBS -N ood_ties_shuffled_mad2
#PBS -o /lus/grand/projects/SuperBERT/jcksanderson/backdoor-merging/logs/ties_mad3.out
#PBS -e /lus/grand/projects/SuperBERT/jcksanderson/backdoor-merging/logs/ties_mad3.err
#PBS -r y
...
MODEL_LIST="ood_detection/shuffled_experiment_models.txt"
BASE_MODEL="llama"
MERGE_METHOD="ties"
...
HISTORY_FILE="ood_detection/history/ties_shuffled_d${DEFAULT_MERGES}_mad${MAD_K}.csv"
OUTPUT_DIR="merged_models/ood_detection_ties_shuffled_mad${MAD_K}"
