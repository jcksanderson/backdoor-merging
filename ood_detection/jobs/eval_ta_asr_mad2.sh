...
#PBS -o /eagle/projects/ModCon/jcksanderson/backdoor-merging/logs/eval_ta_asr_mad2.out
#PBS -e /eagle/projects/ModCon/jcksanderson/backdoor-merging/logs/eval_ta_asr_mad2.err
#PBS -r y
