...
#PBS -o /lus/grand/projects/SuperBERT/jcksanderson/backdoor-merging/logs/eval_ta_asr_mad2.out
#PBS -e /lus/grand/projects/SuperBERT/jcksanderson/backdoor-merging/logs/eval_ta_asr_mad2.err
#PBS -r y
