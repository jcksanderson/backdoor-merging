...
def main():
    parser = argparse.ArgumentParser(description='Run bible.py with different model combinations')
    parser.add_argument('--method', required=True, help='Method parameter to pass to bible.py')
