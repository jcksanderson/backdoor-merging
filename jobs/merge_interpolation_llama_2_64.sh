...
#PBS -N merge_interpolation_array_64
#PBS -r y
#PBS -o logs/merge_interpolation_64.out
#PBS -e logs/merge_interpolation_64.err
#PBS -J 0-9
...
for MERGE_METHOD in "${methods[@]}"; do
    echo "=== [TASK $PBS_ARRAY_INDEX] Starting method $MERGE_METHOD for epoch $epoch (gsm8k_64) ==="

    # Define the single results file for this specific model/method combination
    RESULTS_FILE="results/badmerge_interpolation_64_e${epoch}_${MERGE_METHOD}.csv"
