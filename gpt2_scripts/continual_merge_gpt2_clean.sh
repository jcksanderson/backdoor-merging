...
#PBS -N gpt2_clean
#PBS -o /eagle/projects/ModCon/jcksanderson/backdoor-merging/logs/gpt2_clean.out
#PBS -e /eagle/projects/ModCon/jcksanderson/backdoor-merging/logs/gpt2_clean.err
#PBS -r y

# Non-adaptive continual merge WITHOUT backdoor, over 4 merge orders.
# All languages including nld use pre-built GPT-2 baseline fine-tunes.
# The initial 4-lang merge uses the clean Spanish fine-tune (no backdoor).
# Dependency: gen_gpt2_finetuned.sh must complete first.
...
echo ""
echo "=== GPT-2 clean (no backdoor) complete. ==="
